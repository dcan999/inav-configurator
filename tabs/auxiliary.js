...
TABS.auxiliary.initialize = function (callback) {
    ...
    const modeSections = {};
        ...
        modeSections["Flight Mode Modifiers"] = ["NAV ALTHOLD", "HEADING HOLD", "AIR MODE", "Airspeed Auto Throttle", "Ground Speed Auto Throttle", "NAV Speed Set Adjust", "SOARING", "SURFACE", "TURN ASSIST"];
